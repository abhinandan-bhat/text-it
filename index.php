...
<br />
Welcome to our messaging site. Happy chatting.</h1><br /><br />
<style>
h1 {
  font-size: 20px;
}
...
?>
	<tr>
        ...
        <td><?php echo '<a href="new_pm.php?rec_id='. $dn1['username'].'"class="link_new_pm">Reply</a>';?></td>
    </tr>
<?php
}
...
<a href="dbdump.php">Click here to view databases</a><br/>
<br /><br />
